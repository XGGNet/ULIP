...
from data.dataset_omic import Dataset_OMIC
...
def get_dataset_omic(train_transform, tokenizer, args, dataset_name=None):
    dataset_omic = Dataset_OMIC(args, tokenizer, dataset_name, train_transform)
    return dataset_omic.dataset
